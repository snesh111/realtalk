  ...
  return (
    <div className="max-w-md mx-auto mt-16">
      <div className="bg-[#1a1a2e] border border-[#2a2a3e] rounded-2xl p-8">
        <h1 className="text-2xl font-bold text-gray-100 mb-2">Join RealTalk</h1>
        <p className="text-gray-500 text-sm mb-8">Real questions. Honest answers.</p>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link to="/login" className="text-[#6C63FF] hover:underline">Login</Link>
        </p>
      </div>
    </div>
  );
